...
module.exports = {
  content: [
    "./app/**/*.{js,ts,jsx,tsx}",   // ou "./pages/**/*.{js,ts,jsx,tsx}", selon ton projet
    "./pages/**/*.{js,ts,jsx,tsx}",
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        bounceSlow: { '0%, 100%': { transform: 'translateY(-5%)' }, '50%': { transform: 'translateY(0)' } },
        ...
        floatDelay: { '0%, 100%': { transform: 'translateY(0)' }, '50%': { transform: 'translateY(15px)' } },
      },
      animation: {
